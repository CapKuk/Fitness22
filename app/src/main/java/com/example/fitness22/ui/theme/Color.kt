...
val DarkOnSurfaceVariant = Color(0xFFB0B8C5)
val DarkSecondary = Color(0xFF4CAF50) // Green for completed
val DarkTertiary = Color(0xFF58A6FF) // Bright blue accent
val DarkOutline = Color(0xFF3A4556)
val ExerciseListBackground = Color(0xFF151B28) // More visible blue for exercise list